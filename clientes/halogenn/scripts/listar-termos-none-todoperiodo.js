/**
 * Garimpo NONE — Todo o período, sem filtro de impressões, espelhando o export do UI
 */
...
async function listar() {
  ...
  console.log('\n=== TERMOS NONE — TODO O PERÍODO (sem filtro de impressões) ===\n');
  ...
  const rows = await customer.query(`
    ...
    WHERE segments.date BETWEEN '2024-01-01' AND '2026-04-28'
  ...
  rows.forEach((r, i) => {
    const termo  = r.search_term_view.search_term.substring(0, 47);
