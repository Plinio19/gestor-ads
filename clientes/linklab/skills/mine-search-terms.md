...
## Objetivo
Garimpar os termos de busca das campanhas ativas da Linklab, identificar oportunidades e ameaças, e gerar recomendações fundamentadas.
...
- campaign, ad_group, keyword, search_term, match_type
- impressions, clicks, cost, conversions, conversions_value, ctr
...
### 6. Atenção especial para a Linklab
- Termos de manutenção/reparo → sempre negativar
- Termos de uso doméstico → negativar
- Termos de volume industrial sem contexto lab → negativar
- Termos de novas categorias não mapeadas → monitorar e reportar oportunidade
